...
public class AffectedAdvicePair {
	...
	private AdviceToCheck a;
	private AdviceToCheck b;
	...
	public AffectedAdvicePair(AdviceToCheck a, AdviceToCheck b) {
		this.a = a;
		this.b = b;
	}

	public AdviceToCheck getA() {
		return a;
	}

	public void setA(AdviceToCheck a) {
		this.a = a;
	}

	public AdviceToCheck getB() {
		return b;
	}

	public void setB(AdviceToCheck b) {
		this.b = b;
	}
